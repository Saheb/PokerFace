...
<body>
  <form action="http://127.0.0.1/PokerFace/startGame.php" method="get">
    ...
    <div class="container-fluid">
      <div class="row-fluid">
        <div class="span4" style="padding-left:80px">
          <div class="well sidebar-nav">
            <b style="font-size: 25px">Players</b>
            <b style="font-size: 25px;padding-left: 80px">Ready</b><br><br>
            <div id="users">

            </div>
          </div>
      </div>
      <div class="span6" style="padding-left:190px;length:300px">
          <div class="well sidebar-nav">
            <h2>Chat Box</h2>
            <textarea id='log' name='log' readonly='readonly'>Chat Module will come soon :)</textarea><br/>
